...
import app.yomu.netbar.databinding.FragmentBottomSheetListBinding
import app.yomu.netbar.databinding.ItemBottomSheetListBinding
import app.yomu.netbar.main.WindowEdgeManager
import app.yomu.netbar.network.isLoading
...
abstract class AbsBottomSheetListFragment<T, H : RecyclerView.ViewHolder> :
    ...
    open fun setData(list: List<T>) {
        ...
        binding.recyclerView.post { behavior.state = BottomSheetBehavior.STATE_HALF_EXPANDED }
    }
